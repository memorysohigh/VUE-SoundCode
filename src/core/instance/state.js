...
// 使用的是Object.defineProperty()跟Proxy无关
export function proxy(target: Object, sourceKey: string, key: string) { //(target代理，sourcekey代理目标，key代理属性)
...
function createComputedGetter(key) {
  //'※ ※computed属性值会缓存的原理※ ※'  也是在这里结合 watcher.dirty、watcher.evalaute、watcher.update 实现的
...
function createWatcher(
  ...
  // 如果 handler 为普通对象，则获取其中的 handler 选项的值
